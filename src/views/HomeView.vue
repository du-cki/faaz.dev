...
import type { ListRepositoryPayload, Project, Song } from "../payloads";
...
<template>
  <Wrapper>
    <div
      class="w-screen h-screen flex flex-col items-center justify-around md:justify-center"
    >
      <div class="w-screen p-10 md:p-20">
        ...
        <div class="flex pt-3">
          ...
          <a
            href="mailto:meow@faaz.dev"
            v-tooltip="'meow@faaz.dev'"
            target="_blank"
          >
            <svg
              width="40px"
        ...
        <div class="flex justify-end items-center h-full">
          <div>
            ...
            <p class="text-right" v-if="songData">
              ...
              <a
                class="text-black dark:text-white text-bold"
                :href="songData.track_url"
                v-tooltip="{
                  content:
      ...
      <div class="flex justify-end items-center pt-14 lg:pt-20 w-full">
        <div class="text-right w-full">
          ...
          <div class="base flex-col lg:flex-row lg:pt-10 pt-3 w-full">
            ...
            <ProjectCard
              v-for="project in getRecentRepositories"
