...
export default defineComponent({
  ...
  mounted() {
    ...
    this.connection.onmessage = (event: MessageEvent) => {
      ...
      if (data.event === "SPOTIFY") {
        switch (data.state) {
          case "UPDATE":
            this.songData = JSON.parse(data.song); // due to JSON.parse not recursively parsing, which is fair.
            break;
          case "STOP":
            this.songData = null;
            break;
...
<template>
  <Wrapper>
      ...
      <div class="w-screen p-10 md:p-20">
        <div class="flex justify-end items-center h-full">
          <div>
            ...
            <p class="text-right" v-if="songData">
              I'm currently listening to
              <a class="text-black dark:text-white text-bold" :href="songData.track_url"
                v-tooltip="{ content: '<img height=\'200\' width=\'200\' src=\'' + songData.track_image + '\'>', html: true, theme: 'album-cover' }"
    ...
    <div class="flex flex-col justify-evenly md:h-screen p-10 md:p-20 md:py-10">
      <div>
        ...
        <p class="md:w-4/6">
          ...
          with expertise in data analysis, machine learning and web development. I'm currently learning
          <a href="https://www.rust-lang.org" target="_blank">Rust</a>
          for its speed, memory safety, and concurrency features for systems programming.
        </p>
      </div>
    ...
    <div class="base">
      <p class="py-2">
        @ 2022
        <a href="https://github.com/du-cki" target="_blank">du-cki</a>. All rights reserved.
      </p>
    </div>
  </Wrapper>
</template>
